    ...
    <div className="fixed z-[1000] w-screen h-screen bg-[rgb(0_0_0_/_30%)] left-0 top-0">
      <div className="w-80 h-80 bg-white relative -translate-x-2/4 -translate-y-2/4 p-5 left-2/4 top-2/4">
        ...
        <div className="relative cursor-pointer">
          ...
          />
          <span
            className="text-[#1e80ff] absolute text-sm right-5 top-2"
        ...
        <div
          className="h-10 leading-10 bg-[#007fff] text-white text-center cursor-pointer mt-[15px] rounded-[5px]"
          onClick={handleLogin}
        >
          登录
        </div>
        <div
          className="text-sm text-[#1e80ff] cursor-pointer mt-[15px]"
